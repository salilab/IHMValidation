...
if __name__ == "__main__":
    ...
    write_html(args.f,Template_Dict,template_html_for)
    write_html(args.f,Template_Dict,template_html_not)
    write_html(args.f,Template_Dict,template_html_un)
