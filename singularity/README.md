...
5. Build the image:
`Apptainer build --build-arg TZ=America/Los_Angeles --build-arg CHIMERA=./chimera-1.20-linux_x86_64_osmesa.bin --build-arg CHIMERAX=./ucsf-chimerax_1.12ubuntu24.04_amd64.deb ihmv.sif Singularity.def`
